...
export const listHeroes: Hero[] = [
  ...
  { id: 13, name: 'AXE', type: Prime.STRENGTH, status: Status.Radiant},
  { id: 14, name: 'PUDGE', type: Prime.STRENGTH, status: Status.Radiant},
  { id: 15, name: 'SAND KING', type: Prime.STRENGTH, status: Status.Radiant},
  { id: 16, name: 'SLARDAR', type: Prime.STRENGTH, status: Status.Radiant},

  { id: 17, name: 'BLOODSEEKER', type: Prime.AGILITY, status: Status.Radiant},
  { id: 18, name: 'SHADOW FIEND', type: Prime.AGILITY, status: Status.Radiant},
  { id: 19, name: 'RAZOR', type: Prime.AGILITY, status: Status.Radiant},
  { id: 20, name: 'VENOMANCER', type: Prime.AGILITY, status: Status.Radiant},

  { id: 21, name: 'BANE', type: Prime.INTELLIGENCE, status: Status.Radiant},
  { id: 22, name: 'LICK', type: Prime.INTELLIGENCE, status: Status.Radiant},
  { id: 23, name: 'LION', type: Prime.INTELLIGENCE, status: Status.Radiant},
  { id: 24, name: 'WITCH DOCTOR', type: Prime.INTELLIGENCE, status: Status.Radiant},
];